...
public class FifoBatchedInboxBuilderTests
{
    private readonly IServiceCollection _services;

    public FifoBatchedInboxBuilderTests()
    {
        _services = new ServiceCollection();
    }

    private IFifoBatchedInboxBuilder CreateBuilder(string inboxName = "test-inbox")
    {
        var parentBuilder = new InboxBuilder(_services, inboxName);
        return parentBuilder.AsFifoBatched();
    }
    ...
    public void RegisterHandler_GenericType_ReturnsBuilder()
    {
        ...
        var result = builder.RegisterHandler<TestFifoBatchedHandler, TestFifoMessage>();
    ...
    public void RegisterHandler_FactoryDelegate_ReturnsBuilder()
    {
        ...
        var result = builder.RegisterHandler<TestFifoMessage>(sp => new TestFifoBatchedHandler());
    ...
    {
        var builder = CreateBuilder();
        var handler = new TestFifoBatchedHandler();
    ...
    {
        IFifoBatchedInboxBuilder builder = CreateBuilder();
    ...
    private class TestFifoBatchedHandler : IFifoBatchedInboxHandler<TestFifoMessage>
    {
        public Task<IReadOnlyList<InboxMessageResult>> HandleAsync(string groupId, IReadOnlyList<InboxMessageEnvelope<TestFifoMessage>> messages, CancellationToken token)
        {
